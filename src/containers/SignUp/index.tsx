    ...
    <AuthenticationLayout caption="Sign up Here">
      <form onSubmit={handleSubmit(onSubmit)} className="SingUnForm-form">
        <div>
          <input
            ...
            {...register('first_name', {
              ...
              maxLength: {
                value: 50,
                message: 'First name can have maximum 50 characters.',
              },
            })}
          ...
          />
          <p className="SingUnForm-error">{errors.first_name?.message}</p>
        </div>
        <div>
          <input
            id="last_name"
            {...register('last_name', {
              ...
              maxLength: {
                value: 50,
                message: 'Last name can have maximum 50 characters.',
              },
            })}
            ...
            className="inputField"
          />
          <p className="SingUnForm-error">{errors.last_name?.message}</p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            {...register('confirmPhone', {
              ...
              validate: (value) => {
                return (
                  value === getValues('phone') || 'Phone numbers do not match'
                );
              },
            })}
          />
        ...
        <div>
          ...
          />
          <button className="btn" onClick={toggleConfirmPassword} type="button">
            <AiOutlineEye />
          </button>
          <p className="SingUnForm-error">
