...
import { getUserSubscription, getStatus, managePayment, cancelSubscription, checkoutPlan } from '../../services/subscriptionService';
import {
    ...
    const fetchUserSubscription = () => {
        ...
        getUserSubscription()
            ...
            if (response.data.data.subscriptionData.renewalDate) {
                ...
                new Date(response.data.data.subscriptionData.renewalDate).toUTCString()
                );
                setUserPlan({
                ...response.data.data,
                subscriptionData: {
    ...
    return (
        ...
        >
            ...
            <div className="Content-wrap Sub">
                ...
                {userPlanStatus == 'subscription_active' || (userPlanStatus == 'subscription_expired' && userAccountState == 'past_due') || (userPlanStatus == 'subscription_cancelled' && userAccountState == 'past_due') ?
                (<button
                ...
                <>
                    ...
                    >
                    <Meta
                        title={<div className={styles['Question-title']}>{userPlan?.subscriptionData.name}</div>}
                        ...
                        <div className={styles['Question']}>
                            ...
                            <>
                                ...
                                <p className={styles['otherDates']}>
                                {dateFormatRenewal(userPlan?.subscriptionData.endDate)}
                                </p>
                            </>
                            )}
                            {userPlanStatus == 'subscription_active' && (
                                ...
                                <p className={styles['otherDates']}>
                                    {dateFormatRenewal(userPlan?.subscriptionData.renewalDate)}
                                </p>
                                </>
                            )}
                        </div>
