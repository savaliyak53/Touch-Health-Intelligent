            ...
            <Layout defaultHeader={true} hamburger={true} dashboard={false}>
                <div className="Content-wrap Corr">
                    ...
                    <div className="Corr-wrap">
                        ...
                        <div className="Each-Relation">
                            <div className="Text-btn">
                                <p className="Text">
                                    Your salt consumption is a large contributor
                                    to your hypertension management
                                </p>
                        ...
                        <div className="Each-Relation">
                            <div className="Text-btn">
                                <p className="Text">
                                    Reduced alcohol consumption is a large
                                    contributor to your hypertension management
                                </p>
                                <div className="Arrow-btn">
