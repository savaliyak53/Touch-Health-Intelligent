...
const TermsAndCondtions: FC = () => {
  ...
  return (
    <Layout defaultHeader={true} hamburger={false} addPadding={true} title={'Terms and Conditions'}>
      <div className='sm:max-h-[76vh] max-h-[75vh] flex flex-col items-center justify-between'>
        <div className='overflow-y-auto'>
          <p className='text-left text-[16px] leading-[2]'>
            ...
            your use of the touchmedical.ca website (“Website”), “Cur8 Health” mobile application
            ...
            Touch Medical Intelligence Inc. (“Touch Medical Intelligence Inc.”, “we”, “us” or “our”). If
            ...
            this agreement and may not access and use the Services. By accessing and using the
            Services, you acknowledge that you have read, understood, and agree to be bound by
            the terms of this Agreement. You acknowledge that this Agreement is a contract
            between you and Touch Medical Intelligence Inc., even though it is electronic and is not
            physically signed by you, and it governs your use of the Services.
          </p>
          <div className='font-tilt-warp mt-7 mb-7 text-left text-primary-delft-dark font-normal text-[22px] leading-[36px]' >
            Accounts and membership
          </div>
          <p className='text-left text-[16px] leading-[2]'>
            You must be at least 18 years of age to use the Services. By using the Services and by
            agreeing to this Agreement you warrant and represent that you are at least 18 years of
            age. If you create an account on the Services, you are responsible for maintaining the
            security of your account and you are fully responsible for all activities that occur under
            the account and any other actions taken in connection with it. We may, but have no
            obligation to, monitor and review new accounts before you may sign in and start using
            ...
            of your account or any other breaches of security. We will not be liable for any acts or
            omissions by you, including any damages of any kind incurred as a result of such acts
            or omissions. We may suspend, disable, or delete your account (or any part thereof) if
            we determine that you have violated any provision of this Agreement or that your
            conduct or content would tend to damage our reputation and goodwill. If we delete your
            account for the foregoing reasons, you may not re-register for our Services. We may
          ...
          <p className='text-left text-[16px] leading-[2]'>
            ...
            are offered on a free trial basis, payment may be required after the free trial period ends,
            and not when you enter your billing details (which may be required prior to the
            commencement of the free trial period). If auto-renewal is enabled for the Services you
            have subscribed for, you will be charged automatically in accordance with the term you
            selected. If, in our judgment, your purchase constitutes a high-risk transaction, we will
            require you to provide us with a copy of your valid government-issued photo
            identification, and possibly a copy of a recent bank statement for the credit or debit card
            used for the purchase. We reserve the right to change products and product pricing at
            any time. We also reserve the right to refuse any order you place with us. We may, in our
          ...
          <p className='text-left text-[16px] leading-[2]'>
            ...
            errors, inaccuracies or omissions that may relate to promotions and offers. We reserve
            ...
            undertake no obligation to update, amend or clarify information on the Services
            including, without limitation, pricing information, except as required by law. No specified
            update or refresh date applied on the Services should be taken to indicate that all
          ...
          <p className='text-left text-[16px] leading-[2]'>
            ...
            any claim against Touch Medical Intelligence Inc. with respect to such other services.
            Touch Medical Intelligence Inc. is not liable for any damage or loss caused or alleged to
            be caused by or in connection with your enablement, access or use of any such other
            services, or your reliance on the privacy practices, data security processes or other
            policies of such other services. You may be required to register for or log into such other
            services on their respective platforms. By enabling any other services, you are expressly
            permitting Touch Medical Intelligence Inc. to disclose your data as necessary to
          ...
          <p className='text-left text-[16px] leading-[2]'>
            ...
            stated herein. We are not responsible for examining or evaluating, and we do not
          ...
          <p className='text-left text-[16px] leading-[2]'>
            ...
            the Services or Content: (a) for any unlawful purpose; (b) to solicit others to perform or
            ...
            submit false or misleading information; (g) to upload or transmit viruses or any other
            type of malicious code that will or may be used in any way that will affect the
            functionality or operation of the Services, third party products and services, or the
            Internet; (h) to spam, phish, pharm, pretext, spider, crawl, or scrape; (i) for any obscene
            or immoral purpose; or (j) to interfere with or circumvent the security features of the
          ...
          <p className='text-left text-[16px] leading-[2]'>
            ...
            to you any intellectual property owned by Touch Medical Intelligence Inc. or third
            parties, and all rights, titles, and interests in and to such property will remain (as
            between the parties) solely with Touch Medical Intelligence Inc. All trademarks, service
            marks, graphics and logos used in connection with the Services, are trademarks or
            registered trademarks of Touch Medical Intelligence Inc. or its licensors. Other
            trademarks, service marks, graphics and logos used in connection with the Services
            may be the trademarks of other third parties. Your use of the Services grants you no
            right or license to reproduce or otherwise use any of Touch Medical Intelligence Inc. or
          ...
          <p className='text-left text-[16px] leading-[2]'>
            ...
            your use of the Services is solely at your own risk. We expressly disclaim all warranties
            ...
            make no warranty that the Services will meet your requirements, or that the Service will
            be uninterrupted, timely, secure, or error-free; nor do we make any warranty as to the
          ...
          <p className='text-left text-[16px] leading-[2]'>
            To the fullest extent permitted by applicable law, in no event will Touch Medical
            Intelligence Inc., its affiliates, directors, officers, employees, agents, suppliers or
            ...
            negligence or otherwise, even if the liable party has been advised as to the possibility of
            such damages or could have foreseen such damages. To the maximum extent
            permitted by applicable law, the aggregate liability of Touch Medical Intelligence Inc.
            and its affiliates, officers, employees, agents, suppliers and licensors relating to the
            services will be limited to an amount no greater than one dollar or any amounts actually
            paid in cash by you to Touch Medical Intelligence Inc. for the prior one month period
          ...
          <p className='text-left text-[16px] leading-[2]'>
            You agree to indemnify and hold Touch Medical Intelligence Inc. and its affiliates,
            directors, officers, employees, agents, suppliers and licensors harmless from and
          ...
          <p className='text-left text-[16px] leading-[2]'>
            ...
            arising out of it shall be governed by the substantive and procedural laws of Alberta,
            Canada without regard to its rules on conflicts or choice of law and, to the extent
            applicable, the laws of Canada. The exclusive jurisdiction and venue for actions related
            to the subject matter hereof shall be the courts located in Alberta, Canada, and you
          ...
          <p className='text-left text-[16px] leading-[2]'>
            ...
            page. We may also provide notice to you in other ways at our discretion, such as
            through the contact information you have provided. An updated version of this
            Agreement will be effective immediately upon the posting of the revised Agreement
            unless otherwise specified. Your continued use of the Services after the effective date
            of the revised Agreement (or such other act specified at that time) will constitute your
          ...
          <TouchButton
              className='my-4 px-8 !w-[65%] mx-auto'
              type={'default'}
              onClick={onSubmit}>
            Confirm and sign-up
          </TouchButton>
