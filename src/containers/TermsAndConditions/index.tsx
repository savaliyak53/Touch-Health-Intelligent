      ...
      <div  className={styles.Container}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} onScroll={handleScroll} style={{maxHeight: 600, overflow: 'auto'}}>
          <Paragraph className={styles.TermsText}>
           ...
           \n\n`}</Paragraph>
          <Title level={1} className={styles.TermsTitle3} style={{color:'#6A2C70'}}>Accounts and membership</Title>

          <Paragraph className={styles.TermsText}>{`\n\nYou must be at least 18 years of age to use the Services. By using the Services and by agreeing to this Agreement you warrant and represent that you are at least 16 years of age.
          ...
          <Title level={2} className={styles.TermsTitle3} style={{color:'#6A2C70'}}>Billing and payments</Title>
          ...
          <Title level={2} className={styles.TermsTitle3} style={{color:'#6A2C70'}}>Accuracy of information
          </Title>
          ...
          <Title level={2} className={styles.TermsTitle3} style={{color:'#6A2C70'}}>Third party services</Title>
          ...
          <Title level={2} className={styles.TermsTitle3} style={{color:'#6A2C70'}}>Links to other resources</Title>
          ...
          <Title level={2} className={styles.TermsTitle3} style={{color:'#6A2C70'}}>Prohibited uses</Title>
          ...
          <Title level={2} className={styles.TermsTitle3} style={{color:'#6A2C70'}}>Intellectual property rights</Title>
          ...
          <Title level={2} className={styles.TermsTitle3} style={{color:'#6A2C70'}}>Disclaimer of warranty</Title>
          ...
          <Title level={2} className={styles.TermsTitle3} style={{color:'#6A2C70'}}>Limitation of liability</Title>
          ...
          <Title level={2} className={styles.TermsTitle3} style={{color:'#6A2C70'}}>Indemnification</Title>
          ...
          <Title level={2} className={styles.TermsTitle3} style={{color:'#6A2C70'}}>Severability</Title>
          ...
          <Title level={2} className={styles.TermsTitle3} style={{color:'#6A2C70'}}>Dispute resolution</Title>
          ...
          <Title level={2} className={styles.TermsTitle3} style={{color:'#6A2C70'}}>Changes and amendments</Title>
          ...
          <Title level={2} className={styles.TermsTitle3} style={{color:'#6A2C70'}}>Acceptance of these terms</Title>
