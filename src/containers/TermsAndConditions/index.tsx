  ...
  return (
    <Layout defaultHeader={true} hamburger={false} withoutMargin={true}>
      <div  className={styles.Container}>
        <h2 className={`text-left font-tilt-warp text-3xl md:text-4xl tracking-wide pt-16 text-normal pb-12 z-50 fixed bg-white w-full top-0 terms-title`} >Terms and Conditions</h2>
